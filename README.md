...
- Task Table workflows: rows derived from tagged outline nodes, tag/assignee/due-date filters, editable priority/progress/assignee/start/due/notes fields, readonly category/tag columns, sortable headers, persisted table preferences, column visibility controls, and expanded table mode.
