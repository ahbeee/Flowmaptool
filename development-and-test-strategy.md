...
- Task Workbench derived from tagged outline nodes, including quick capture, personal views, tag/assignee/due-date filters, editable task fields, bulk task updates, readonly tag/category columns, sortable headers, persisted table preferences, column visibility controls, and expanded workspace mode.
...
- Outline hierarchy, checklist persistence, Task Workbench derivation, quick capture, personal task views, task field editing, bulk task updates, task filtering, task sorting, persisted table preferences, column visibility, and expanded task table mode.
