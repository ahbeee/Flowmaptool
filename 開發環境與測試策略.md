...
- Outline and checklist panel with hierarchy mirroring, selection sync, collapsible nodes, persisted checklist state, and tag-derived task targets.
- Task table derived from tagged checklist nodes, including editable task fields, readonly tag/category columns, sortable headers, and expanded workspace mode.
...
- Outline, checklist persistence, task table derivation, task field editing, task sorting, and expanded task table mode.
